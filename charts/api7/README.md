...
![Version: 0.17.2](https://img.shields.io/badge/Version-0.17.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.3.2](https://img.shields.io/badge/AppVersion-3.3.2-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v3.3.2"` |  |
...
| developer_portal.image.tag | string | `"v3.3.2"` |  |
...
| dp_manager.image.tag | string | `"v3.3.2"` |  |
