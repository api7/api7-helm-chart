...
![Version: 0.16.21](https://img.shields.io/badge/Version-0.16.21-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.2.16](https://img.shields.io/badge/AppVersion-3.2.16-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v3.2.16.7"` |  |
...
| developer_portal.image.tag | string | `"v3.2.16.7"` |  |
...
| dp_manager.image.tag | string | `"v3.2.16.7"` |  |
