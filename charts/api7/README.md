...
![Version: 0.17.16](https://img.shields.io/badge/Version-0.17.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.8.5](https://img.shields.io/badge/AppVersion-3.8.5-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v3.8.5"` |  |
...
| developer_portal.image.tag | string | `"v3.8.5"` |  |
...
| dp_manager.image.tag | string | `"v3.8.5"` |  |
