...
![Version: 0.17.15](https://img.shields.io/badge/Version-0.17.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.8.4](https://img.shields.io/badge/AppVersion-3.8.4-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v3.8.4"` |  |
...
| developer_portal.image.tag | string | `"v3.8.4"` |  |
...
| dp_manager.image.tag | string | `"v3.8.4"` |  |
