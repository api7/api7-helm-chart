...
![Version: 0.17.9](https://img.shields.io/badge/Version-0.17.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.6.0](https://img.shields.io/badge/AppVersion-3.6.0-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v3.6.0"` |  |
...
| developer_portal.image.tag | string | `"v3.6.0"` |  |
...
| dp_manager.image.tag | string | `"v3.6.0"` |  |
