...
![Version: 0.17.41](https://img.shields.io/badge/Version-0.17.41-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.9.3](https://img.shields.io/badge/AppVersion-3.9.3-informational?style=flat-square)
...
| dashboard.image.tag | string | `"v3.9.3"` |  |
...
| developer_portal.image.tag | string | `"v3.9.3"` |  |
...
| dp_manager.image.tag | string | `"v3.9.3"` |  |
